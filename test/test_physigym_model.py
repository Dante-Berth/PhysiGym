...
class TestPhysigymTemplate(object):
    ...
    def test_physigym_template_classic(self):
        ...
        s_result = subprocess.run(['sed', '-ie ', r's/<max_time units="min">[0-9.]*<\/max_time>/<max_time units="min">1440<\/max_time>/g', 'config/PhysiCell_settings.xml'], check=False, capture_output=True)
